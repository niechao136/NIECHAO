...
async function init(detCustomModel = null, recCustomModel = null) {
...
async function recognize(image, options) {
  ...
  for (let i = 0; i < boxes.length; i++) {
      ...
      for (let i = 0; i < width_num; i++) {
          ...
          const recResult = new recPostprocess(output);
...
function resize_norm_img_splice(image, origin_width, origin_height, index = 0) {
